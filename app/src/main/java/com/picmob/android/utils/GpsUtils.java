...
public class GpsUtils {
    ...
    public void turnGPSOn(GpsCallBack mOnGpsListener) {
        onGpsListener = mOnGpsListener;
                    ...
                    .addOnFailureListener((Activity) context, e -> {
                        ...
                        switch (statusCode) {
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                String errorMessage = context.getString(R.string.error_location_inadequate);
